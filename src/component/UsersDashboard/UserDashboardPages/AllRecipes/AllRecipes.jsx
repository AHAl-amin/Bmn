...
import { useGetAllRecipesQuery } from "../../../../Rudux/feature/ApiSlice";
...
// 		category: "Chocolate",
// 		description:
// 			"A light and airy chocolate dessert with a molten center....",
...
function AllRecipes() {
	const { data, isLoading, isError, error } = useGetAllRecipesQuery(1);
	...
	if (isLoading) {
		return (
			<div className="flex justify-center items-center h-screen text-[#5B21BD] text-2xl">
				Loading recipes...
			</div>
		);
	}
			...
			<div className="flex justify-between">
				<div className="w-1/2">
					...
					<p className="text-[#A2A2A2] text-[20px]">
						Browse and discover recipes from your favorite culinary
						experts.
					</p>
				</div>
						...
						>
							<div className="relative">
								<img
									...
									src={
										recipe.image
											? `${apiBaseURL}${recipe.image}`
											: "https://placehold.co/600x400?text=Placeholder+Image"
									}
									alt={recipe.title}
								/>
							</div>
							<div className="p-4 border-x-2 border-b-2 rounded-b-xl border-gray-100 space-y-2">
								...
								<div className="mt-3 flex justify-between items-center">
									...
									<p className="text-sm text-gray-500">
										Updated: {formatDate(recipe.created_at)}
									</p>
								</div>
								<Link
