...
function RecipesDettails() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'Ingredients':
        return (
          <div className="px-6 py-4">
            <h2 className="text-xl font-semibold text-[#004C3F] mb-4">Recipe Ingredients</h2>
            <div className="space-y-6">
              <div className="flex text-[#999999] gap-6">
                <p className="w-4/10 border border-[#999999] rounded-[10px] py-3 px-3">Dark chocolate</p>
                <p className="w-2/10 border border-[#999999] rounded-[10px] text-center py-3 px-3">200g</p>
      ...
      case 'Instructions':
        return (
          <div className="px-6 py-4">
            <h2 className="text-xl font-semibold text-[#004C3F] mb-4">Recipe Instructions</h2>
            <div className="space-y-6 text-[#999999]">
              <p className="w-full border border-[#999999] rounded-[10px] py-3 px-3">
      ...
      case "Chef's Notes":
        return (
          <div className="px-6 py-4">
            <h2 className="text-xl font-semibold text-[#004C3F] mb-4">Chef's Notes</h2>
            <div className="space-y-6 text-[#999999]">
              <p className="w-full border border-[#999999] rounded-[10px] py-3 px-3">
                1. For the crust: Combine flour, butter, and powdered sugar in a food processor until crumbly.
              </p>
  ...
  if (!recipe) {
    return (
      <div className="py-6 px-10">
        <p className="text-[#004C3F] text-xl">Recipe not found.</p>
      </div>
    );
  }
  ...
  return (
    <div className="py-6 px-10">
      <div className="rounded-lg overflow-hidden py-3 px-3">
        ...
        <div className="flex justify-between items-center px-2 mt-2 py-4">
          <div>
            <span className="bg-[#B0BFB6] rounded-[29px] px-3 py-1 mr-5 text-[#004C3F]">
        ...
        <div className="flex bg-[#D9E0DC] py-2 justify-around text-[20px] rounded-[10px]">
          <button
            className={`px-20 py-2 rounded-[10px] ${
              activeTab === 'Ingredients' ? 'bg-[#004C3F] text-white' : 'text-gray-600'
            }`}
            onClick={() => handleTabClick('Ingredients')}
          >
            Ingredients
          ...
          <button
            className={`px-20 py-2 rounded-[10px] ${
              activeTab === 'Instructions' ? 'bg-[#004C3F] text-white' : 'text-gray-600'
            }`}
            onClick={() => handleTabClick('Instructions')}
          >
            Instructions
          ...
          <button
            className={`px-20 py-2 rounded-[10px] ${
              activeTab === "Chef's Notes" ? 'bg-[#004C3F] text-white' : 'text-gray-600'
            }`}
            onClick={() => handleTabClick("Chef's Notes")}
          >
            Chef's Notes
          ...
          <button
            className={`px-20 py-2 rounded-[10px] ${
              activeTab === 'Comments' ? 'bg-[#004C3F] text-white' : 'text-gray-600'
            }`}
            onClick={() => handleTabClick('Comments')}
          >
            Comments
