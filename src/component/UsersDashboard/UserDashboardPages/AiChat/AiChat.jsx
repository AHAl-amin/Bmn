...
const AiChat = () => {
    ...
    // State to track like/dislike status for each message
            ...
            if (type === "like") {
                return {
                    ...
                    [index]: {
                        ...
                        dislike: currentReaction.dislike && false, // Disable dislike if liking
                    },
                };
            } else {
                return {
                    ...prev,
                    [index]: {
                        like: currentReaction.like && false, // Disable like if disliking
                        ...
                        <div key={index} className="flex w-full">
                            {message.isUser ? (
                                <div className="flex flex-col items-end w-full">
                                    ...
                                    {/* Like/Dislike for user messages */}
