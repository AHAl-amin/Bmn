...
const AdminDashboardSidebar = () => {
	...
	const isDashboardActive = [
		"/Admin_Dashboard",
		"/chef_all_recipes/chef_recipese_dettails_view",
		"/dashboard/createBuyerOrder",
		"/dashboard/buyer_candidate_list",
			...
			>
				...
				<div className="flex flex-col gap-2 pt-5 mx-5">
					...
					<NavLink
						...
						className={() =>
							location.pathname.startsWith(
								"/Admin_Dashboard/chefs"
							) ||
							location.pathname.startsWith(
								"/chef_dashboard/chef_recipese_dettails_view"
							) ||
							location.pathname.startsWith(
								"/chef_dashboard/chef_recipese_edit_page"
							)
					...
					<NavLink
						...
						className={() =>
							location.pathname.startsWith(
								"/Admin_Dashboard/settings_privecy"
							) ||
							location.pathname.startsWith(
								"/chef_dashboard/chef_recipese_dettails_view"
							) ||
