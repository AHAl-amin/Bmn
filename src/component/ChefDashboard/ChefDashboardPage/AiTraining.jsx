...
//     formDataToSend.append('category', formData.Recipe);
//     if (files.length > 0) {
...
//             label: recipesData?.data?.find((recipe) => recipe.id === formData.Recipe)?.title || 'Unknown',
//           }
//         : null
//     }
//     onChange={(selectedOption) => {
//       const selectedValue = selectedOption ? selectedOption.value : '';
//       console.log('Selected Recipe ID:', selectedValue); // Log the selected recipe ID
//       handleInputChange({ target: { name: 'Recipe', value: selectedValue } });
//     }}
//     options={
//       isRecipesLoading
...
//             value: recipe.id, // Use recipe.id as the value
//             label: `${recipe.title}`, // Display title in the dropdown
//           }))
//     }
...
//         } p-2`,
//       menu: () => 'max-h-[20vh] overflow-y-auto absolute top-full left-0 right-0 bg-white border border-[#5B21BD] rounded-b-md shadow-md z-20',
...
//                 className="px-4 py-2 bg-[#5B21BD] text-white rounded disabled:opacity-50"
//                 onClick={nextStep}
//                 disabled={!formData.fileTitle || !formData.Recipe}
//               >
//                 Next
//               </button>
//             </div>
...
//                 <div>
//                   {recipesData?.data?.find((r) => String(r.id) === String(formData.Recipe))?.title || 'No recipe'}
//                 </div>
...
//                   <p><strong>Category:</strong> {formData.Recipe}</p>
