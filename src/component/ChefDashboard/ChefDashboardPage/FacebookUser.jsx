...
//         // Add unfilled stars for the remaining
...
//                     <p className="text-[#9E9E9E]  text-[20px] mb-6">Manage feedback from users on your recipes</p>
//                 </div>
...
//                                     className="px-4 py-2  hover:bg-[#5B21BD]/10 cursor-pointer"
//                                 >
//                                     All
//                                 </div>
...
//                                         className="px-4 py-2 hover:bg-[#5B21BD]/10 cursor-pointer capitalize"
//                                     >
//                                         {recipe}
//                                     </div>
//                                 ))}
...
//                                     All
//                                 </div>
//                                 {["One", "Two", "Three", "Four", "ive"].map((rating) => (
//                                     <div
//                                         key={rating}
