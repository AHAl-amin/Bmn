                  ...
                  >
                    ...
                    {openDropdownId === recipe.id && (
                      <ul className="absolute right-0 z-50 mt-2 w-30 origin-top-right rounded-md border border-[#5B21BD] bg-gray-200 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none menu menu-sm p-2">
                        <li>
                          <NavLink
                            to={`/chef_dashboard/chef_recipese_edit_page/${recipe.id}`}
...
//   // Handle edit click and fetch recipe details
//   const handleEditClick = (id) => {
//     const { data: recipeDetails } = useGetRecipeDettailsQuery({ id });
...
//                         <li>
//                           <NavLink
//                             to={`/chef_dashboard/chef_recipese_dettails_view/${recipe.id}`}
//                             className="cursor-pointer"
//                           >
//                             Edit
//                           </NavLink>
