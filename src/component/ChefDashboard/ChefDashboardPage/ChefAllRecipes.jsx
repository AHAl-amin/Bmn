...
const initialRecipes = [
    ...
    {
        id: 4,
        title: 'Desserts Chocolate Soufflé',
        category: 'Desserts',
        description: 'A light and airy chocolate dessert with a molten center....',
        image: 'https://i.ibb.co.com/NdC53ZPN/image-1.jpg',
        rating: 4.8,
        ...
        <div>
            <div className="md:px-10 py-6 lora">
                ...
                <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-between gap-6 pt-6">
                            ...
                            <div className="p-4 border-x-2 border-b-2 rounded-b-xl border-gray-100 space-y-2">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    >
                                        ...
                                        {openDropdownId === recipe.id && (
                                            <ul className="absolute right-0  border-none bg-gray-100 z-50 mt-2 w-20 origin-top-right rounded-md  shadow-lg ring-1  menu-sm p-2">
                                                <li>
                                                    <button>Edit</button>
                                                </li>
                                                <li>
                    ...
                    <Link to="/chef_dashboard/chef_recipese_dettails_view" className=" shadow  h-full rounded-xl p-2 text-white flex justify-center items-center ">
                       ...
                       <div className='bg-[#0077B6] rounded-full flex justify-center items-center mx-auto w-[50px] h-[50px]'>
                        ...
                        <button className='flex bg-[#0077B6] py-1 px-3 rounded-full  items-center gap-2'>add new member <IoMdAdd /></button>
                       </div>
                    </Link>
                </div>
